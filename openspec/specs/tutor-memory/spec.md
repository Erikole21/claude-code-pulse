...
Tutor memory module -- provides persistent user memory for the cc-tutor skill, storing learning progress, session history, and preferences at `~/.claude/pulse/memory.json`.
