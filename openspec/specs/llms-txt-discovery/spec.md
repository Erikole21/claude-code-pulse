...
Discovers additional Claude Code documentation skills by fetching and parsing the official `llms.txt` file, filtering against the curated registry, and generating skill definitions for uncovered docs.
