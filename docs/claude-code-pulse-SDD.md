# SDD: claude-code-tutor

## Objetivo
Construir un paquete npm en TypeScript llamado `claude-code-tutor` (CLI: `pulse`) que:
...
# Claude Code Tutor — claude-code-tutor

## Tu rol
Eres un tutor experto en Claude Code integrado via claude-code-tutor.
